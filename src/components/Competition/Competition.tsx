      ...
      <Box>
        ...
        <Box mt="xl" mb={75} ta="center">
          <Text size="sm">
            ...
            initiative on the cutting-edge Price Forecasting subnet. Dive into a
            world where your data science and AI skills can earn you real
            rewards, all while contributing to the growth of the decentralized
            Bittensor network. Whether you&apos;re a student, a professional, or
            an AI enthusiast, this is your chance to make an impact and be
        ...
        <Box mb="lg">
          ...
          <List withPadding>
            ...
            <List.Item>
              Provide a hands-on learning experience in a simulated environment
              akin to our mainnet.
            </List.Item>
            <List.Item>
        ...
        <Box mb="lg">
          <Text>
            Participants will engage in predicting the intraday price movements
            of Bitcoin, leveraging Taoshi&apos;s advanced tools and resources.
            The competition will run continuously with weekly resets, allowing
            for fresh opportunities to climb the ranks. Weekly resets will occur
            every Friday at 1:00 PM eastern standard time. Registration for all
            competitors is{" "}
        ...
        <Box mb="lg">
          <Text mb="sm">
            The top 3 miners at the time of the weekly reset will be rewarded in
            $TAO with the following payout structure:
          </Text>
          <List withPadding>
            <List.Item>
              1st place:{" "}
        ...
        <Box mb="xl">
          <Text>
            These tokens are not just a symbol of victory; they are a gateway to
            Taoshi&apos;s subnet and a testament to your skill. This reward
            should allow participants to pay completely or partially to register
            as a miner on main-net.
          </Text>
        </Box>
        ...
        <Box mb="xl">
          ...
          <Text>
            ...
            for quick solutions to common queries. Need more help? Our dedicated{" "}
        ...
        <Box>
          ...
          <Text>
            Participation in Taoshi&apos;s Testnet Competition is subject to our
