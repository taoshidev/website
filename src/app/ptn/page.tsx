			...
			<Box>
				...
				<Box mb={75}>
					...
					<Text mb="sm">
						...
						outputs generated by PTN, please stay tuned as Taoshi&apos;s Request
					...
					<Text>
						...
						service, where users can manually execute informed trades. To access
						their signal service, please visit their{" "}
